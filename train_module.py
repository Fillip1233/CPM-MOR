...
if __name__ == "__main__":
    ...
    parser.add_argument("--module_name", type= str, default= "res_ann")
    ...
    if args.draw_type == 0:
        ...
        for i in range(100):
            ...
            im2 = axs[2].imshow((yte[i].cpu()-ypred[1].cpu()).abs(), cmap = 'viridis', interpolation='nearest', vmin = vmin, vmax = vmax, aspect='auto')
